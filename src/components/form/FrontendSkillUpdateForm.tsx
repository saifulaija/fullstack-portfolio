...
const FrontendSkillUpdateForm = ({ data }: IFrontendSkillUpdateProps) => {
    const { toast } = useToast();
    const [updateFrontendSkill, { isLoading: update }] = useUpdateFrontendSkillMutation();
    ...
    const onSubmit = async (values: any) => {
        ...
        try {
            ...
            if (res?.data) {
                toast({
                    title: "Success",
                    description: "Frontend skill updated  successfully",
                    action: (
...
export default FrontendSkillUpdateForm;
