...
import { IToolsSkillUpdateProps } from "@/types/toolsSkill.type";
import { useUpdateToolsSkillMutation } from "@/redux/features/toolsSkill/tollsSkillApi";
const ToolsSkillUpdateForm = ({ data }: IToolsSkillUpdateProps) => {
    const { toast } = useToast();
    const [updateFrontendSkill, { isLoading: update }] = useUpdateToolsSkillMutation();
    ...
    const onSubmit = async (values: any) => {
        ...
        try {
            ...
            if (res?.data) {
                toast({
                    title: "Success",
                    description: "Tools skill updated  successfully",
                    action: (
...
export default ToolsSkillUpdateForm;
